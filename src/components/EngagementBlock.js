...
const EngagementBlock = ({ engagementBlock }) => {
  ...
  const cardClasses =
    "card  w-full items-center justify-center max-w-screen-md bg-base-300 text-base-content border-primary border-4 p-4 shadow-xl"; // Limited max-width for large screens
        ...
        {image_url && (
          <div className={imageContainerClasses}>
            <img
              src={image_url}
              alt="Hero Image"
              style={{ maxHeight: "40vh", maxWidth: "100%", width: "auto" }}
            />
          </div>
        )}
