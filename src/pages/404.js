...
function Custom404({ site }) {
  ...
  const page = {
    title: "Not Found",
    description: "Something went wrong looking up that Page.",
  };
  return (
  ...
  pages: [
    {
      ...
      page_description:
        "We're building your site and content right now, and everything should be ready shortly! You can refresh this page to see it update in realtime.",
      content_blocks: [
        {
          type: "TextBlock",
          page: 0,
